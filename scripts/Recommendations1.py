...
# Print recommendations for 2 users
users_to_display = list(all_user_recommendations.keys())[:2]
for user in users_to_display:
    print(f"Recommendations for {user}: {all_user_recommendations[user]}")
...
def get_recommendations():
    return jsonify(all_user_recommendations)
