<template>
  ...
  <div class=" flex flex-col cardWidth relative shadow-2xl rounded-3xl color">
    <div class="relative">
      <!-- Main image -->
      <div
        class="gg" @mouseenter="isHovered = true"
      ...
      >
        ...
        >
          <div class="flex">
            <svg
              class="w-6 mt-1 h-6 iconn text-gray-800 dark:text-white" aria-hidden="true"
          ...
          <div class="flex">
            <svg
              class="w-6 h-6 mt-1 ml-1 text-gray-800 iconn dark:text-white" aria-hidden="true"
          ...
          <div class="flex">
            ...
            <Link
              :href="route('admin.product.destroy',product)" method="delete" as="button"
    ...
    <div v-if="showFirstImage">
      <img
        :src="'https://i.imghippo.com/files/pgMMB1712509469.png'" alt="status" class="absolute top-0"
        style="right: 0;"
      />
