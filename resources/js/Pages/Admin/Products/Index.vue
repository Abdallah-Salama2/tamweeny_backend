...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class=" flex flex-row flex-wrap gap-10   justify-center  mt-2  ">
            <Link :href="route('admin.product.create')"><img class="cardWidth"  src="https://i.imghippo.com/files/gNcoH1712448873.png" alt=""></Link>
...
<!--            <div>{{products}}</div>-->
            <product-card
                ...
                :key="product.id"
                :product="product"
                :selectedImage="'https://i.imghippo.com/files/zs3Zz1712448566.png'"
