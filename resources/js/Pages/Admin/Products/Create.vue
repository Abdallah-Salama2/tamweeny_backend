    ...
    <AuthenticatedLayout>
        <div class=" overflow-y-visible mt-3   relative">
            ...
            <form @submit.prevent="create" enctype="multipart/form-data">
                ...
                <div @mouseenter="isHovered = true" @mouseleave="isHovered = false" class="relative" style="margin-right: 730px">
                ...
                <div class="gg">
                    ...
                    <div class="" style="position: absolute; left: 500px; top:420px">
                        ...
                        <button class="mb-20" type="reset" @click="reset" style="background:#345E37;color:#C6FFE6;width: 200px;justify-content: center;padding: 10px;border-radius: 20px">تفريغ</button>
                    </div>
                </div>
            </form>
        </div>
