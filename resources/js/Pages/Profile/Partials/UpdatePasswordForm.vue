  ...
  <section>
    <header>
      ...
      <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
        تأكد من استخدام كلمة مرور طويلة وعشوائية لضمان الأمان.
      </p>
    </header>
    ...
    <form class="mt-6 space-y-6" @submit.prevent="updatePassword">
      ...
      <div>
        <InputLabel for="password_confirmation" value="تاكيد كلمة المرور" />
      ...
      <div class="flex items-center gap-4">
        ...
        >
          <p v-if="form.recentlySuccessful" class="text-sm text-gray-600 dark:text-gray-400">تم الحفظ</p>
        </Transition>
      </div>
    </form>
  </section>
