...
import PrimaryButton from '@/Components/Breeze Componenets/PrimaryButton.vue'
...
<template>
  <section>
    <header>
      <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">بيانات الحساب</h2>

      <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
        قم بتحديث معلومات ملف تعريف حسابك وعنوان البريد الإلكتروني.
      </p>
    </header>
    ...
    <form class="mt-6 space-y-6" @submit.prevent="form.patch(route('profile.update'))">
      ...
      <div>
        <InputLabel for="email" value="الحساب الالكتروني" />
      ...
      <div>
        <InputLabel for="area" value="منطقة الخدمة " />
