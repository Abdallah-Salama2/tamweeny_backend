    ...
    <GuestLayout>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="flex mt-6 mr-12" style="width:300px ;">
                    ...
                    >
                        <svg class="w-4 h-4 mt-1 text-gray-800 dark:text-white" aria-hidden="true"
            ...
            <div class="flex items-center justify-end mt-4 w">
                ...
                <PrimaryButton class="ms-4 text-xs  iconColor textColor" :class="{ 'opacity-25': form.processing }"
