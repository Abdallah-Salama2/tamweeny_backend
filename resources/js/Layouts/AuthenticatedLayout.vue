                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <div v-if="can('can-list-offers')">
                            ...
                            <ResponsiveNavLink :href="route('admin.offer.index')"
                    ...
                    <li>
                        <ResponsiveNavLink :href="route('admin.product.index')"
                            ...
                            <span
                                ...
                                style="background:rgba(97,188,132,70%) ">3</span>
                        </ResponsiveNavLink>
                    </li>
                    <li>
                    ...
                    <li>
                        <ResponsiveNavLink :href="route('admin.delivery.index')"
                    ...
                    <li>
                        <ResponsiveNavLink :href="route('admin.supplier.index')"
                    ...
                    <li>
                        <ResponsiveNavLink :href="route('admin.order.index')"
                    ...
                    <li>
                        <ResponsiveNavLink :href="route('supplier.order.index')"
                    ...
                    <li>
                        <ResponsiveNavLink :href="route('admin.user.create')"
