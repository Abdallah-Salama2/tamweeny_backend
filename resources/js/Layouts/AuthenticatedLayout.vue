      ...
      <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
          <div class="flex items-center justify-start rtl:justify-end">
            ...
            <div v-if="can('can-list-products')">
    ...
    >
      <div class="h-full px-3 pb-4 overflow-y-auto  dark:layout mt-2">
        ...
        <ul class="space-y-2 font-medium">
          ...
          <li>
            <div v-if="can('can-list-categories')">
              <ResponsiveNavLink
          ...
          <!--All Deliveries-->
          <li>
            <div v-if="can('can-list-deliveries')">
              <ResponsiveNavLink
          ...
          <!--All Suppliers-->
          <li>
            <div v-if="can('can-list-suppliers')">
              <ResponsiveNavLink
          ...
          <!--All Orders Status-->
          <li>
            <div v-if="can('can-list-admin-orders')">
              <ResponsiveNavLink
          ...
          <li>
            <div v-if="can('can-list-supplier-orders')">
              <ResponsiveNavLink
